...
import sty from "./PlasmicButton.module.css"; // plasmic-import: mFh1b29Pfxhj/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: 7f-joq4uQeg3/icon
import ChevronDown2Icon from "./icons/PlasmicIcon__ChevronDown2"; // plasmic-import: u2AOk31ysxGR/icon
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__teFLl, {
          [sty.freeBoxcolor_neutral__teFLlbLZnx]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_white__teFLlJnIzr]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxroundedFull__teFLlWIcIb]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__teFLlMGbsz]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__teFLlyMibR]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__teFLlOvJSh]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__teFLlbfyio]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__teFLl2M8L8]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__teFLl2M8L8ULsOn]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__xq4Ie, {
            [sty.freeBoxcolor_neutral__xq4IebLZnx]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__xq4IebLZnxDNyiI]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__xq4Iesyt5K]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__xq4IeMGbsz]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__xq4IeOvJSh]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__xq4Iebfyio]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__xq4Ie2M8L8]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__yOokP)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___4OHz, {
            [sty.freeBoxiconEnd___4OHzIHHhe]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge___4OHzMGbsz]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___4OHzOvJSh]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___4OHzBfyio]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDown2Icon
                className={classNames(projectcss.all, sty.svg__kaFhs)}
                role={"img"}
              />
            ),
