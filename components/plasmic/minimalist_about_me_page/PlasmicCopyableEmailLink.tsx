...
import sty from "./PlasmicCopyableEmailLink.module.css"; // plasmic-import: uk1mkEl2emF5/css

createPlasmicElementProxy;

export type PlasmicCopyableEmailLink__VariantMembers = {};
export type PlasmicCopyableEmailLink__VariantsArgs = {};
type VariantPropType = keyof PlasmicCopyableEmailLink__VariantsArgs;
export const PlasmicCopyableEmailLink__VariantProps =
  new Array<VariantPropType>();

export type PlasmicCopyableEmailLink__ArgsType = {
  children?: React.ReactNode;
  eMailAddress?: string;
};
type ArgPropType = keyof PlasmicCopyableEmailLink__ArgsType;
export const PlasmicCopyableEmailLink__ArgProps = new Array<ArgPropType>(
  "children",
  "eMailAddress"
);

export type PlasmicCopyableEmailLink__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultCopyableEmailLinkProps {
  children?: React.ReactNode;
  eMailAddress?: string;
  className?: string;
}
...
function PlasmicCopyableEmailLink__RenderFunc(props: {
  variants: PlasmicCopyableEmailLink__VariantsArgs;
  args: PlasmicCopyableEmailLink__ArgsType;
  overrides: PlasmicCopyableEmailLink__OverridesType;
  forNode?: string;
}) {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicCopyableEmailLink__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicCopyableEmailLink__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicCopyableEmailLink__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCopyableEmailLink__ArgProps,
          internalVariantPropNames: PlasmicCopyableEmailLink__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicCopyableEmailLink__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicCopyableEmailLink";
  } else {
    func.displayName = `PlasmicCopyableEmailLink.${nodeName}`;
  }
  return func;
}

export const PlasmicCopyableEmailLink = Object.assign(
  // Top-level PlasmicCopyableEmailLink renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicCopyableEmailLink
    internalVariantProps: PlasmicCopyableEmailLink__VariantProps,
    internalArgProps: PlasmicCopyableEmailLink__ArgProps
  }
);

export default PlasmicCopyableEmailLink;
/* prettier-ignore-end */
