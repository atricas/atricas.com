...
import sty from "./PlasmicNavbar.module.css"; // plasmic-import: zavPxtdCzwg9/css
...
function PlasmicNavbar__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__ndkFa)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__uTinx)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__lZkCc)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__yOm8F)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__v5IsZ)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__zxNb)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
